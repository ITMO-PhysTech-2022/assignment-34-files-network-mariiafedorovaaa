...
* если в текущей строке до курсора больше `count` символов, надо
...
Для тестирования работоспособности придется настроить возможность одновременного запуска двух приложений
(гайд появится в канале чуть позже, здесь будет ссылка на соответствующее сообщение).
